...
| 자동 타겟팅                                            | 보스 버튼 활성화                                           | 장비 슬롯                                              | 던전 맵                                             |
| ------------------------------------------------------ | ---------------------------------------------------------- | ------------------------------------------------------ | --------------------------------------------------- |
| <img src="./Docs/Img/auto_targeting.gif" width="300"/> | <img src="./Docs/Img/enable_boss_button.gif" width="300"/> | <img src="./Docs/Img/equipment_info.gif" width="300"/> | <img src="./Docs/Img/dungeon_map.gif" width="300"/> |

| 장비 강화 (확률)                                          | -   | -   | -   |
| --------------------------------------------------------- | --- | --- | --- |
| <img src="./Docs/Img/enhance_equipment.gif" width="300"/> | -   | -   | -   |
